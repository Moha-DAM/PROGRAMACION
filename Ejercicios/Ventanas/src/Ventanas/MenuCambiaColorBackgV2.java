...
public class MenuCambiaColorBackgV2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MenuCambiaColorBackgV2 ventanaCambiarColor = new MenuCambiaColorBackgV2();
...
// METODOS ------------------------------------------------------------------
	...
	private void eventos() {
		mntmRojo.addActionListener(  e -> contentPane.setBackground(Color.red));
		mntmVerde.addActionListener( e -> contentPane.setBackground(Color.GREEN));
		mntmAzul.addActionListener(  e ->  contentPane.setBackground(Color.blue));
	}
